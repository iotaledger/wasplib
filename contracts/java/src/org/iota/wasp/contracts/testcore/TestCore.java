...
public class TestCore {
    ...
    public static void funcCallOnChain(ScFuncContext ctx, FuncCallOnChainParams params) {
        ...
        ScMutableInt64 varCounter = ctx.State().GetInt64(Consts.VarCounter);
        ...
        ScImmutableInt64 retVal = ret.GetInt64(Consts.ParamIntValue);
    ...
    public static void viewFibonacci(ScViewContext ctx, ViewFibonacciParams params) {
        ...
        long n1 = results1.GetInt64(Consts.ParamIntValue).Value();
        ...
        long n2 = results2.GetInt64(Consts.ParamIntValue).Value();
    ...
    public static void viewGetInt(ScViewContext ctx, ViewGetIntParams params) {
        ...
        ScImmutableInt64 value = ctx.State().GetInt64(new Key(name));
