...
const HFuncCallIncrement = client.ScHname(0x96b915f2)
const HFuncCallIncrementRecurse5x = client.ScHname(0x30319639)
const HFuncIncrement = client.ScHname(0xd351bd12)
const HFuncInit = client.ScHname(0x1f44d644)
const HFuncLocalStateInternalCall = client.ScHname(0xc4e9cbef)
const HFuncLocalStatePost = client.ScHname(0x90051958)
const HFuncLocalStateSandboxCall = client.ScHname(0x07431bc8)
const HFuncPostIncrement = client.ScHname(0xb775b58a)
const HFuncRepeatMany = client.ScHname(0x020e669e)
const HFuncResultsTest = client.ScHname(0xf73a0ee0)
const HFuncStateTest = client.ScHname(0x5691431b)
const HFuncWhenMustIncrement = client.ScHname(0x28a49492)
const HViewGetCounter = client.ScHname(0xb8e70081)
const HViewResultsCheck = client.ScHname(0xfaf7081b)
const HViewStateCheck = client.ScHname(0xc760249d)
