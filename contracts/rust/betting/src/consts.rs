...
pub const SC_NAME:        &str = "betting";
pub const SC_DESCRIPTION: &str = "Betting description";
pub const HSC_NAME:       ScHname = ScHname(0xf3d6937a);
...
pub const STATE_ROUNDS: &str = "rounds";
